...
task = StringVar()
task_entry = Entry(frame,width=18,font='arial 20',bd=0,command=addTask)
...
Button(root,image=Delete_icon,bd=0,command=deteteTask).pack(side=BOTTOM,pady=13)
